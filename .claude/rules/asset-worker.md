...
- LOD `.glb` nhỏ (<5MB, Draco/meshopt + KTX2, <50k tris); derivative ảnh shop chụp (AVIF/WebP/JPEG) pre-gen lúc upload; serve **immutable content-hash URL** sau Cloudflare cache.
