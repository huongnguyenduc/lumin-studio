...
export const vi = {
  ...
  rsvp: {
    ...
    nameRequired: 'Bạn nhập tên trước khi xác nhận nhé.',
    identityRequired: 'Chờ chúng mình một chút rồi bạn xác nhận nhé.',
  },
  identity: {
    retry: 'Thử lại việc ghi nhớ',
  },
  wish: {
  ...
  admin: {
    ...
    settings: {
      ...
      saveFailed: 'Lưu cài đặt thất bại — thử lại nhé',
    ...
    drawer: {
      open: 'Cài đặt',
      title: 'Cài đặt',
      tabEvent: 'Địa điểm & lịch trình',
      tabSite: 'Cài đặt trang',
      close: 'Đóng',
      noEvent: 'Chưa có đám cưới nào để chỉnh — thêm một đám cưới trước nhé.',
      unsavedWarn: 'Bạn có thay đổi chưa lưu ở tab này. Rời đi mà không lưu?',
    },
    eventPanel: {
    ...
    table: {
      ...
      openedAt: 'Đã mở · {ago}',
      notOpened: 'Chưa mở',
      openDevices: '{count} lượt · {devices}',
      copy: 'Sao chép link',
      open: 'Mở',
      edit: 'Sửa',
      delete: 'Xoá',
    ...
    shared: {
      heading: 'Khách từ link chung',
      subtitle: 'Tách riêng khỏi danh sách thiệp cá nhân',
      empty: 'Chưa có khách nào mở link chung.',
      unnamed: 'Khách chưa nhập tên',
      opens: '{count} lượt · gần nhất {ago}',
      yes: 'Tham dự',
      no: 'Không tham dự',
      pending: 'Chưa phản hồi',
      admin: 'Thiết bị admin',
      currentDevice: 'Thiết bị này',
      guest: 'Thiết bị khách',
      markAdmin: 'Đây là admin',
      unmarkAdmin: 'Bỏ đánh dấu',
      delete: 'Xoá',
      deleteAll: 'Xoá toàn bộ GI',
      deleteAllConfirm:
        'Xoá toàn bộ Guest Identity, phản hồi link chung và lịch sử mở? Không thể hoàn tác.',
      deleteConfirm: 'Xoá GI của “{name}”? Dữ liệu phản hồi và lượt mở cũng sẽ bị xoá.',
      claimDevice: 'Xác nhận thiết bị khác',
      claimPrompt: 'Mở link này trên điện thoại cần xác nhận trong 10 phút:',
      claimCopied: 'Đã sao chép link xác nhận thiết bị',
      claimFailed: 'Không tạo được link xác nhận',
      confidence: {
        token: 'Nhận diện bằng mã trình duyệt',
        fingerprint: 'Đối chiếu bằng dấu hiệu thiết bị',
        new: 'Thiết bị mới',
      },
    },
    device: {
      summary: '{browser} · {device}',
      browser: {
        zalo: 'Zalo',
    ...
    export: {
      ...
      wishSheet: 'Lời chúc',
      sharedSheet: 'Khách từ link chung',
      ...
      colTime: 'Thời gian',
      colDevice: 'Thiết bị',
      colOpenCount: 'Số lượt mở',
      colAdmin: 'Thiết bị admin',
      adminYes: 'Có',
      openedYes: 'Đã mở',
      openedNo: 'Chưa mở',
      rsvpYes: 'Tham dự',
