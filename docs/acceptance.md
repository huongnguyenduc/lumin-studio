...
## Cụm 13 — Storefront catalog read (`docs/plans/phase-1-storefront.md` §2 · P1-a/P1-c)
...
> list active-only tại SQL `ListActiveProducts status='active'` + `maxPageSize` bound + classify `GetProducts` authPublic) **+**
