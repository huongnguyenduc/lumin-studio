...
**— Stage 2d build (admin order-detail + print read — BE denormalize-at-capture + admin FE) — on `feat/adr037-2d-admin-print-read` (off `main` `accc38c`) —**
