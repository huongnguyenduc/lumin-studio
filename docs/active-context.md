...
**— Stage 4 slice 4b build (deduct-on-print + định-mức catalog — BE, money/ops) — on `feat/adr039-4b-deduct-print` (off fresh `main` `2eb7fd0` = 4a #82 merged) —**
