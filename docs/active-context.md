...
> **Phase-1 sub-PR tally: 14/19 MERGED** (a,b,c,d,e,f,g,h,j,k,l,m,n,o — P1-o #46 merged → `origin/main` `518b326`). Remaining: P1-i (360 media — degrade-only, sprite pipeline unconfirmed) · **P1-q (SEO — this branch, PR #47 CI green, chờ merge)** · P1-p (consent analytics) · P1-r/s (customer auth — BLOCKER-2: needs credentials migration + auth-mechanism decision, gated on user).
