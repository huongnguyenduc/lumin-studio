...
> **Phase-1 sub-PR tally: 13/19 MERGED** (a,b,c,d,e,f,g,h,j,k,l,m,n). Remaining: P1-i (360 media — degrade-only, sprite pipeline unconfirmed) · **P1-o (guest lookup — IN PROGRESS)** · P1-p (consent analytics) · P1-q (SEO) · P1-r/s (customer auth — BLOCKER-2: needs credentials migration + auth-mechanism decision, gated on user).
