...
| Mở PR / review / merge một feature | `conventions.md` §Scope & PR + §Session hygiene + `.github/PULL_REQUEST_TEMPLATE.md` (ADR-027) |
| Đối chiếu UI với thiết kế (visual-fidelity) | `conventions.md` §Visual-fidelity + `/design-system.md` + `designs/*.dc.html` (ADR-027) |
